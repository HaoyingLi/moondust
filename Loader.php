...
use Moon\Lib\Framework\UrlManager;

class Loader{

	public static $aliases = ['@Moon' => __DIR__];
	...
	public static function run(){
		...
		$controller = UrlManager::createControllerByID( 'Moon\\Modules\\'.ucfirst($module).'\\Controllers', $controller );
